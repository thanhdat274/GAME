...
### Requirement: Migrate bản lưu v3 lên v4 nhiều cửa hàng
Khi tải bản lưu version 3, hệ thống SHALL bọc tiệm hiện tại thành `stores[0]` (tiệm chính), tách dữ liệu chung (tiền, level, danh hiệu, thành tựu), gán lịch game ở ngày 1 tháng 3 năm 1, và giữ bản v3 làm dự phòng.
